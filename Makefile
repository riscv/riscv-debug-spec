...
INCLUDES_TEX += Zdebug.tex
INCLUDES_TEX += Ztrigger.tex
...
debug_defines.h:	$(REGISTERS_TEX:.tex=.h)
	echo "/*" > $@
	echo " * This file is auto-generated by running 'make debug_defines.h' in" >> $@
	echo " * https://github.com/riscv/riscv-debug-spec/ (`git log -1 --format="format:%h"`)" >> $@
	echo " * License: Creative Commons Attribution 4.0 International Public License (CC BY 4.0)" >> $@
	echo " */" >> $@
	echo >> $@
	cat $^ >> $@
