...
SPDX_LICENSE_ID = SPDX-License-Identifier: BSD-2-Clause OR CC-BY-4.0
...
debug_defines.c: SPDX_LICENSE_TAG := "/* $(SPDX_LICENSE_ID) */"
debug_defines.h: SPDX_LICENSE_TAG := "// $(SPDX_LICENSE_ID)"

debug_defines.%:
	echo $(SPDX_LICENSE_TAG) > $@
	echo "/*" >> $@
