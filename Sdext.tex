...
\item All memory accesses are executed as if in machine mode, except that
...
\item CSR accesses are allowed to all CSRs that can be accessed from machine
    mode.  Debug mode CSRs are also accessible.
