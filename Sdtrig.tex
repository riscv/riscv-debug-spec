...
Only triggers with \FcsrMcontrolSixSize=0 and \FcsrMcontrolSixSelect=0 will
match. These triggers must at least be compared against the lowest virtual
address covered by any of the affected cache lines, or the virtual address that
is the argument
to the instruction. Comparing against both of these is better, and best of all
is to match against any virtual address covered by any of the affected cache
lines.
