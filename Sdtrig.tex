...
address of all affected cache lines, or the virtual address that is the argument
to the instruction. Comparing against both of these is better, and best of all
is to match against the virtual address covered by all affected cache lines.
