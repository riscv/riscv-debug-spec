...
\item Every virtual address that is affected by the cache operation is a compare
    value.
\item The lowest virtual address that is affected by the cache operation is a
    compare value.
\item The virtual address that is the argument to the instruction is a compare
    value.
\end{steps}
