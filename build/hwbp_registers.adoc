// Auto-generated on 2026-04-02 13:25:55.315783 from ../xml/hwbp_registers.xml
...
15 (disabled): This trigger is disabled. In this state, {csr-tdata2} and
...
a|Preset
|[[tdata1-dmode]] `((dmode))`
a|If {tdata1-type} is 0, then this bit is hard-wired to 0.

0 (both): Both Debug and M-mode can write the `tdata` registers at the
selected {csr-tselect}.


1 (dmode): Only Debug Mode can write the `tdata` registers at the
...
a|0
|[[tdata1-data]] `((data))`
a|If {tdata1-type} is 0, then this field is hard-wired to 0.
...
a|Contains the version of the Sdtrig extension implemented.
...
a|Preset
|[[tinfo-info]] `((info))`
a|One bit for each possible {tdata1-type} enumerated in {csr-tdata1}. Bit N
...
|Field |Description |Access |Reset
|[[scontext-data]] `((data))`
a|Supervisor mode software can write a context number to this
...
a|M-Mode or HS-Mode (using {csr-hcontext}) software can write a context
...
a|Specifies the largest naturally aligned powers-of-two (NAPOT) range
...
a|This field only exists when XLEN is at least 64.
...
a|0
|[[mcontrol-hit]] `((hit))`
a|If this bit is implemented then it must become set when this
...
4 (mask low): Matches when latexmath:[$\frac{XLEN}{2}-{1:0}] of any compare value
...
5 (mask high): Matches when `XLEN-1`:latexmath:[\frac{XLEN}{2}] of any compare
...
a|0
|[[mcontrol-m]] `((m))`
a|When set, enable this trigger in M-mode.
a|*WARL*
a|0
|[[mcontrol-s]] `((s))`
a|When set, enable this trigger in S/HS-mode.
This bit is hard-wired to 0 if the hart does not support
S-mode.
a|*WARL*
a|0
|[[mcontrol-u]] `((u))`
a|When set, enable this trigger in U-mode.
This bit is hard-wired to 0 if the hart does not support
U-mode.
a|*WARL*
a|0
|[[mcontrol-execute]] `((execute))`
a|When set, the trigger fires on the virtual address or opcode of an
instruction that is executed.
a|*WARL*
a|0
|[[mcontrol-store]] `((store))`
a|When set, the trigger fires on the virtual address or data of any
store.
a|*WARL*
a|0
|[[mcontrol-load]] `((load))`
...
a|If implemented, the TM updates this field every time the trigger
fires.
...
a|0
|[[mcontrol6-vs]] `((vs))`
a|When set, enable this trigger in VS-mode.
This bit is hard-wired to 0 if the hart does not support
virtualization mode.
a|*WARL*
a|0
|[[mcontrol6-vu]] `((vu))`
a|When set, enable this trigger in VU-mode.
This bit is hard-wired to 0 if the hart does not support
virtualization mode.
a|*WARL*
a|0
|[[mcontrol6-hit0]] `((hit0))`
a|If they are implemented, {mcontrol6-hit1} (MSB) and
...
a|0
|[[icount-hit]] `((hit))`
a|If this bit is implemented, the hardware sets it when this
...
a|This bit becomes set when {icount-count} is decremented from 1
...
a|0
|[[itrigger-vs]] `((vs))`
a|When set, enable this trigger for interrupts that are taken from VS
mode.
This bit is hard-wired to 0 if the hart does not support
virtualization mode.
a|*WARL*
a|0
|[[itrigger-vu]] `((vu))`
a|When set, enable this trigger for interrupts that are taken from VU
mode.
This bit is hard-wired to 0 if the hart does not support
virtualization mode.
a|*WARL*
a|0
|[[itrigger-nmi]] `((nmi))`
a|When set, non-maskable interrupts cause this
trigger to fire if the trigger is enabled for the current mode.
a|*WARL*
a|0
|[[itrigger-m]] `((m))`
a|When set, enable this trigger for interrupts that are taken from M
mode.
a|*WARL*
a|0
|[[itrigger-s]] `((s))`
a|When set, enable this trigger for interrupts that are taken from S/HS
mode.
This bit is hard-wired to 0 if the hart does not support
S-mode.
a|*WARL*
a|0
|[[itrigger-u]] `((u))`
a|When set, enable this trigger for interrupts that are taken from U
mode.
This bit is hard-wired to 0 if the hart does not support
U-mode.
a|*WARL*
...
a|0
|[[etrigger-vs]] `((vs))`
a|When set, enable this trigger for exceptions that are taken from VS
mode.
This bit is hard-wired to 0 if the hart does not support
virtualization mode.
a|*WARL*
a|0
|[[etrigger-vu]] `((vu))`
a|When set, enable this trigger for exceptions that are taken from VU
mode.
This bit is hard-wired to 0 if the hart does not support
virtualization mode.
a|*WARL*
a|0
|[[etrigger-m]] `((m))`
a|When set, enable this trigger for exceptions that are taken from M
mode.
a|*WARL*
a|0
|[[etrigger-s]] `((s))`
a|When set, enable this trigger for exceptions that are taken from S/HS
mode.
This bit is hard-wired to 0 if the hart does not support
S-mode.
a|*WARL*
a|0
|[[etrigger-u]] `((u))`
a|When set, enable this trigger for exceptions that are taken from U
mode.
This bit is hard-wired to 0 if the hart does not support
U-mode.
a|*WARL*
...
a|This optional bit, when set, causes this trigger to fire whenever an attached
interrupt controller signals a trigger.
a|*WARL*
a|0
|[[tmexttrigger-select]] `((select))`
a|Selects any combination of up to 16 TM external trigger inputs
...
a|When the least significant bit of this field is 1, it causes bits 7:0
