...
If the instruction that is executed causes an exception, Debug Mode is re-entered
immediately after the PC is changed to the exception handler and and the
