...
\item \label{fence} Completing Program Buffer execution is considered output
    for the purpose of {\tt fence} instructions.
    This includes executing an {\tt ebreak} or {\tt dret} instruction, and
    any exceptions that may be encountered.
