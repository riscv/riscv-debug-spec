...
[Authdata]## This register serves as a 32-bit serial port to/from the
...
[DmcsTwo]## This register contains DM control and status bits that
...
|[DmcsTwoDmexttrigger] `dmexttrigger` a|
