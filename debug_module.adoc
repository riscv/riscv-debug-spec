...
[ConfstrptrZero]## When is set, reading this register returns bits
...
[ConfstrptrOne]## When is set, reading this register returns bits
...
[ConfstrptrTwo]## When is set, reading this register returns bits
...
[ConfstrptrThree]## When is set, reading this register returns bits
...
[Nextdm]## If there is more than one DM accessible on this DMI, this
...
[DataZero]## through may be Message Registers, whose behavior is
...
[ProgbufZero]## through must provide write access to the optional
