...
==== Debug Module Status ([[dmstatus]]`dmstatus`, at 0x11)
...
|R |-
|[[dmDmstatusAnyunavail]] `anyunavail`
...
|R |-
|[[dmDmstatusAllrunning]] `allrunning`
|This field is 1 when all currently selected harts are running.
|R |-
|[[dmDmstatusAnyrunning]] `anyrunning`
|This field is 1 when any currently selected hart is running.
|R |-
|[[dmDmstatusAllhalted]] `allhalted`
|This field is 1 when all currently selected harts are halted.
|R |-
|[[dmDmstatusAnyhalted]] `anyhalted`
...
|R |0
|[[dmDmstatusHasresethaltreq]] `hasresethaltreq`
...
|WARZ |-
|[[dmDmcontrolResumereq]] `resumereq`
...
|W1 |-
|[[dmDmcontrolHartreset]] `hartreset`
...
|WARL |0
|[[dmDmcontrolHartsello]] `hartsello`
...
|WARL |0
|[[dmDmcontrolHartselhi]] `hartselhi`
...
|W1 |-
|[[dmDmcontrolClrresethaltreq]] `clrresethaltreq`
|This optional field clears the halt-on-reset request bit for all
currently selected harts. +
Writes apply to the new value of <<hartsel>> and <<hasel>>.
|W1 |-
|[[dmDmcontrolNdmreset]] `ndmreset`
