...
[Command]## Writes to this register cause the corresponding abstract
...
|[CommandCmdtype] `cmdtype` |The type determines the overall
...
[Abstractauto]## This register is optional. Including it allows more
...
[[AbstractautoAutoexecdata]]
[cols="<,<,^,<",options="header",]
|===
|Field |Description |Access |Reset
|_Continued on next page_ | | |

|[AbstractautoAutoexecprogbuf] `autoexecprogbuf` |When a bit in
