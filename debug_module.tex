...
When harts are reset, they must set a sticky {\tt hasreset} state bit.
The {\tt hasreset} state bits can be read for selected harts in the \Fanyhasreset
and \Fallhasreset in \Rdmstatus. These bits should be set regardless of the cause of
the reset. 
They can be cleared by writing 1 to \Fhasresetack in \Rdmcontrol.
