...
down, and not being plugged into the system.  No abstract commands can be
executed while an unavailable hart is selected.
...
Debuggers execute abstract commands by writing them to \Rcommand.  Debuggers
