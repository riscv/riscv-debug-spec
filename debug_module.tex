...
The conceptual {\tt havereset} state bits can be read for selected harts in the \Fanyhavereset
and \Fallhavereset in \Rdmstatus.
These bits should be set regardless of the cause of the reset.
The {\tt havereset} bits for the selected harts
can be cleared by writing 1 to \Fhaveresetack in \Rdmcontrol.
