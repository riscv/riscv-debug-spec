...
\begin{commentary}
    Example: A system with no Program Buffer must support the Access Register
    command, but will still return "not supported" when the Access Register
    command has \Fpostexec set.
\end{commentary}
