...
implement all the required features listed above, at least one of Program Buffer,
System Bus Access, or Abstract Access Memory command mechanisms, and either the
Program Buffer or abstract access to all registers.
