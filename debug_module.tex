...
multiple harts at once. The Nth bit in the Hart Array Mask register is used to
select the hart with index N. Usually a DM will have a Hart Array Mask register
exactly wide enough to select all the harts it supports, but it's allowed to
tie any of these bits to 0.
