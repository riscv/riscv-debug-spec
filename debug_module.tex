...
hart have resumed before clearing \Fresumereq to 0.
If a debugger reads \Fanyresumeack and \Fanyhalted in the same cycle, then some
selected harts must have resumed and then halted again.
