...
Accessing unimplemented Debug Module DMI Registers causes \Fdmerr to be set to
1. Reads to those registers return 0, while writes have no other effect other
than setting \Fdmerr.
