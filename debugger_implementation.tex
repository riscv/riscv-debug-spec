...
There is a good solution if the OS or a debug stub runs in M-Mode while the
...
On tiny system which only supports M-Mode single step is doable, but tricky to
