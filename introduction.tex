...
This specification address the the use cases listed below. Implementations can
choose to not to implement every features, which means some use cases might not
be supported.
