...
\begin{steps}{New backwards-compatible feature that did not exist before:}
    ...
    \item Add \FcsrItriggerNmi bit to \RcsrItrigger. \PR{408}
...
called 1.0 stable.}
\item \FcsrItriggerNmi was moved from \RcsrEtrigger to \RcsrItrigger.
\end{steps}
...
self-contained ISA extensions. The remainder of the document describes the
