...
\begin{description}[style=nextline]
    ...
    \item[component]
        A RISC-V core, or other part of a platform.
        Typically all components will all be connected to a single system
        bus.
    \item[CSR]
    ...
    \item[MIE]
        Machine Interrupt Enable register; also a bit in mstatus.
    \item[NAPOT]
    ...
    \item[PC]
        Program Counter.
    \item[platform]
        A single integrated circuit consisting of one or more \emph{components}.
    \item[physical address]
        An address that is directly usable on the system bus.
    \item[RV32]
        RISC-V core with XLEN of 32.
    \item[RV64]
        RISC-V core with XLEN of 64.
    \item[SBA]
        System Bus Access.
    \item[TAP]
        Test Access Port.
    \item[XLEN]
        Width of the core's integer register file.
    \item[virtual address]
        An address as a hart sees it. If there is address translation this
