...
\begin{description}[style=nextline]
    ...
    \item[Minimal RISC-V Debug Specification]
        The features in Sdext and the Debug Module except that the Program
        Buffer is not required and abstract accesses to registers other than
        GPRs, \RcsrDcsr, and \RcsrDpc are not required.  See
        Chapter~\ref{chap:dm}.
    \item[MR]
...
This document is written to work with all RISC-V ISA extensions ratified up
through 2021.
