...
\newcommand{\versionnum}{0.14.0\ifrelease\else-DRAFT\fi}

\begin{document}

\title{External Debug Support for RISC-V\\
Version \versionnum\\
\GITHash
}
\author{Editors: \\
...
\markboth{External Debug Support for RISC-V Version \versionnum}
{External Debug Support for RISC-V Version \versionnum}
\thispagestyle{empty}
