...
Sections \ref{dmi}, \ref{selectingharts}, \ref{haltcontrol}, \ref{dmcs},
...
\Fdmactive in \Rdmcs is 0. This means that the halt state of all harts is
...
\Rdmcs.  When a debugger wants to halt a hart, it sets \Fhaltreq, waits
...
access key. A few bits in \Rdmcs and \Rauthdata can support an arbitrarily
