...
attached to the DM by trying each index until \Fhartstatus is 3, although a
binary search should be preferred.
...
resume, the debugger clears the bit, and waits for \Fhartstatus to indicate the
hart is running.
