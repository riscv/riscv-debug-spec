...
\hline
8 -- 9 & Signal the firing of the trigger over an external debug trigger output to other blocks within the hart (e.g. as countable events to hpmcounters).  Generate a pulse on external debug trigger output 0 or 1 (respectively). \\
\hline
